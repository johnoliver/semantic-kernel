 ...
 *         The type of the configuration argument that will be provided when
 *         the function is invoked
 */
public interface SKFunction<RequestConfiguration> {
	/*
	 * /// <summary>
	 * /// Name of the function. The name is used by the skill collection and in
	 * prompt templates e.g. {{skillName.functionName}}
	 * /// </summary>
	 * string Name { get; }
	 * 
	 * /// <summary>
	 * /// Name of the skill containing the function. The name is used by the skill
	 * collection and in prompt templates e.g. {{skillName.functionName}}
	 * /// </summary>
	 * string SkillName { get; }
	 * 
	 * /// <summary>
	 * /// Function description. The description is used in combination with
	 * embeddings when searching relevant functions.
	 * /// </summary>
	 ...
	 * /// so when this property is False, executing the function might still
	 * involve AI calls.
	 * /// </summary>
	...
	/// </summary>
	/// <returns>An instance of <see cref="FunctionView"/> describing the
	/// function</returns>
	...
	/*
	 * SKFunction<RequestConfiguration> setDefaultSkillCollection(SkillCollection
	 * skills);
	 * /// <summary>
	 * /// Set the AI service used by the semantic function, passing a factory
	 * method.
	 * /// The factory allows to lazily instantiate the client and to properly
	 * handle its disposal.
	 * /// </summary>
