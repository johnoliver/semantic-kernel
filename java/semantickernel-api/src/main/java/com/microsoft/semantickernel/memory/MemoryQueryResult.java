...
public class MemoryQueryResult {
	 ...
	 *
	 * @param metadata
	 *         Whether the source data used to calculate embeddings are stored in
	 *         the local
	 *         storage provider or is available through an external service, such
	 *         as website, MS Graph,
	 *         etc.
	 * @param relevance
	 *         Search relevance, from 0 to 1, where 1 means perfect match.
	...
	/*
	 * /// <summary>
	 * /// Create a new instance of MemoryQueryResult from a json string
	 * representing MemoryRecord metadata.
	 * /// </summary>
	 * /// <param name="json">The json string to deserialize.</param>
	 * /// <param name="relevance">The similarity score associated with the
	 * result.</param>
