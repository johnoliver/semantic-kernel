...
/**
 * An interface for storing and retrieving indexed {@link MemoryRecord} objects
 * in a data store.
 */
public interface MemoryStore {
	 ...
	 * @param collectionName
	 *         The name associated with a collection of embeddings.
	 * @return A future that completes with a boolean indicating whether the
	 *         collection exists.
	 */
	...
	/**
	 * Upserts a memory record into the data store. Does not guarantee that the
	 * collection exists.
	...
	/**
	 * Upserts a group of memory records into the data store. Does not guarantee
	 * that the collection
	 * exists. If the record already exists, it will be updated. If the record does
	 * not exist, it
	 * will be created.
	 *
	 * @param collectionName
	...
	/**
	 * Removes a batch of memory records from the data store. Does not guarantee
	 * that the collection
	 * exists.
	 *
	 * @param collectionName
	...
	/**
	 * Gets the nearest matches to the {@link Embedding} of type {@code Float}. Does
	 * not guarantee
	 ...
	 *         The name associated with a collection of embeddings.
	 * @param embedding
	 *         The {@link Embedding} to compare the collection's embeddings with.
	 * @param limit
	 *         The maximum number of similarity results to return.
	 * @param minRelevanceScore
	 *         The minimum relevance threshold for returned results.
	 * @param withEmbeddings
	 *         If true, the embeddings will be returned in the memory records.
	 * @return A collection of tuples where item1 is a {@link MemoryRecord} and
	 *         item2 is its
	...
	/**
	 * Gets the nearest match to the {@link Embedding} of type {@code Float}. Does
	 * not guarantee
	 * that the collection exists.
	 *
	 * @param collectionName
	 ...
	 * @param withEmbedding
	 *         If true, the embedding will be returned in the memory record.
	 * @return A tuple consisting of the {@link MemoryRecord} and item2 is its
	 *         similarity score as a
