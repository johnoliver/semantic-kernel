...
public class PromptTemplateConfig {
	...
	public static class CompletionConfig {
		/*
		 * /// <summary>
		 * /// Sampling temperature to use, between 0 and 2. Higher values will make the
		 * output more random.
		...
		/*
		 * /// <summary>
		 * /// Lowers the probability of a word appearing if it already appeared in the
		 * predicted text.
		 * /// Unlike the frequency penalty, the presence penalty does not depend on the
		 * frequency at which words
		...
		/*
		 * /// <summary>
		 * /// Controls the model’s tendency to repeat predictions. The frequency
		 * penalty reduces the probability
		 * /// of words that have already been generated. The penalty depends on how
		 * many times a word has already
		...
		/*
		 * /// <summary>
		 * /// Stop sequences are optional sequences that tells the AI model when to
