...
public abstract class AbstractSkFunction<
  ...
  public Mono<ContextType> invokeAsync(
    ...
    if (context == null) {
      ...
      context =
          buildContext(
              SKBuilders.variables().build(), NullMemory.getInstance(), skillsSupplier.get());
    } else {
            ...
            .map(
                parameter -> {
                  ...
                  if (parameter.getDefaultValue() == null
                    ...
                    defaultValueString = " (default value: " + parameter.getDefaultValue() + ")";
                  }
  ...
  public Mono<ContextType> invokeWithCustomInputAsync(
      ContextVariables input, SemanticTextMemory semanticMemory, ReadOnlySkillCollection skills) {
