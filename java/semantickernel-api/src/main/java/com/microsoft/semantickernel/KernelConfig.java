...
public final class KernelConfig {
  ...
  public static class Builder {
    ...
    public Builder addTextEmbeddingsGenerationService(
        String serviceId, Function<Kernel, EmbeddingGeneration<String, Float>> serviceFactory) {
      if (serviceId == null || serviceId.isEmpty()) {
        throw new IllegalArgumentException("Null or empty serviceId");
      }
    ...
    public Builder setDefaultTextCompletionService(String serviceId) {
      ...
      this.textCompletionServices.put(DEFAULT_SERVICE_ID, textCompletionServices.get(serviceId));
    ...
    public Builder addChatCompletionService(
      ...
      if (serviceId != null && serviceId.toUpperCase().equals(DEFAULT_SERVICE_ID)) {
        String msg = "The service id '" + serviceId + "' is reserved, please use a different name";
        throw new KernelException(KernelException.ErrorCodes.InvalidServiceConfiguration, msg);
      }
