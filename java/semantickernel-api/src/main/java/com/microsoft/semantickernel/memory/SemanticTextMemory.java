...
public interface SemanticTextMemory {
  ...
  /**
   * Fetch a memory by key. For local memories the key is the "id" used when saving the record. For
   * external reference, the key is the "URI" used when saving the record.
   *
  ...
  /**
   * Remove a memory by key. For local memories the key is the "id" used when saving the record. For
   * external reference, the key is the "URI" used when saving the record.
   *
   * @param collection Collection to search.
   * @param key Unique memory record identifier.
