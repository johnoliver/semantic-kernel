...
/**
 * An interface for semantic memory that creates and recalls memories associated
 * with text.
 */
public interface SemanticTextMemory {
	...
	/**
	 * Save some information into the semantic memory, keeping a copy of the source
	 * information.
	 *
	 * @param collection
	...
	/**
	 * Save some information into the semantic memory, keeping only a reference to
	 * the source
	 * information.
	 *
	 * @param collection
	...
	/**
	 * Fetch a memory by key. For local memories the key is the "id" used when
	 * saving the record.
	...
	/**
	 * Remove a memory by key. For local memories the key is the "id" used when
	 * saving the record.
	 * For external reference, the key is the "URI" used when saving the record.
	 *
	 * @param collection
