...
public class KernelFunctionArguments implements Buildable, Map<String, ContextVariable<?>> {
    ...
    public static class Builder implements SemanticKernelBuilder<KernelFunctionArguments> {
         ...
         *
         * @param content
         *            Entry to place in the "input" slot
         ...
         * @return {$code this} Builder for fluent coding
         * @throws SKException
         *             if the content cannot be converted to a ContextVariable
         */
         ...
         *            Entry to place in the "input" slot
         * @param typeConverter
         *            Type converter for the content
         * @return {$code this} Builder for fluent coding
         * @throws SKException
         *             if the content cannot be converted to a ContextVariable
         */
         ...
         * @return {$code this} Builder for fluent coding
         * @throws SKException
         *             if the value cannot be converted to a ContextVariable
         */
