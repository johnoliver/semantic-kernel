...
public class Embedding<EmbeddingType extends Number> {
	...
	// /// </summary>
	// [SuppressMessage("Design", "CA1000:Do not declare static members on generic
	// types",
	...
	//
	// /// <summary>
	// /// Initializes a new instance of the <see cref="Embedding{TEmbedding}"/>
	// class that
	// contains numeric elements copied from the specified collection.
	// /// </summary>
	// /// <exception cref="ArgumentException">Type <typeparamref
	// name="TEmbedding"/> is
	// unsupported.</exception>
	// /// <exception cref="ArgumentNullException">A <c>null</c> vector is passed
	// in.</exception>
	public Embedding() {
	...
	/**
	 * Initializes a new instance of the <see cref="Embedding{TEmbedding}"/> class
	 * that contains
