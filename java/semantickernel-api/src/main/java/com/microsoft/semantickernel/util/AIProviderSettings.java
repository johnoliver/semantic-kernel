...
public class AIProviderSettings {
	/**
	 * Returns an instance of OpenAISettings with key and organizationId from the
	 * environment
	 *
	...
	/**
	 * Returns an instance of AzureOpenAISettings with key, endpoint and
	 * deploymentName from the
	 * environment
	 *
	 ...
	 * @param path
	 *         Path to the properties file
	 * @param clientSettingsId
	 *         ID of the client settings in the properties file schema
	 * @return OpenAISettings
	 */
