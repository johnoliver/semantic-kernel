...
public class Example12SequentialPlanner {
			...
			.setKernelConfig(
				SKBuilders.kernelConfig()
					.addTextCompletionService(
						"text-davinci-002",
						kernel1 -> SKBuilders.textCompletionService()
	...
	public static class EmailSkill {
		...
		public void sendEmail(
			@SKFunctionInputAttribute() @SKFunctionParameters(description = "The body of the email message to send.", name = "input") String input,
			@SKFunctionParameters(description = "The email address to send email to.", name = "email_address") String emailAddress) {
		...
		public String getEmailAddressAsync(
			@SKFunctionInputAttribute() @SKFunctionParameters(description = "The name of the person to email.", name = "input") String input) {
	...
	public void emailSamplesAsync() throws IOException {
		...
		String input = "Once upon a time, in a faraway kingdom, there lived a kind and just king named"
