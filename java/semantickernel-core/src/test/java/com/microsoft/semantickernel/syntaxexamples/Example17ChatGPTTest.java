...
public class Example17ChatGPTTest {
	...
	public void azureOpenAIChatSampleAsync() {
		...
		String secondMessage = "I love history and philosophy, I'd like to learn something new about Greece, any"
			+ " suggestion?";
		...
		ChatHistory.Message createdMessage = chatHistory.getMessages().get(chatHistory.getMessages().size() - 1);
