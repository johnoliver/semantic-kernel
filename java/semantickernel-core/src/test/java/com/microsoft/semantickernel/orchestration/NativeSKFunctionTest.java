...
public class NativeSKFunctionTest {
	...
	public void singleStringIsBoundToInput() {
		...
		FunctionCollection skills = SkillImporter.importSkill(skill, "test", DefaultSkillCollection::new);
	...
	public void nonExistantVariableCreatesError() {
		...
		FunctionCollection skills = SkillImporter.importSkill(skill, "test", DefaultSkillCollection::new);
		ContextVariables variables = SKBuilders.variables().build().writableClone().appendToVariable("input", "foo");
