...
public class MemoryConfiguration {
   ...
   * @throws com.microsoft.semantickernel.KernelException if there is an error getting the embedding
   *     generation service
   */
  public static void useMemory(
      @Nonnull Kernel kernel, @Nonnull MemoryStore storage, @Nullable String embeddingsServiceId) {
   ...
   * @param storage {@link MemoryStore} instance
   * @throws NullPointerException if {@code kernel}, {@code embeddingGenerator}, or {@code storage}
   *     is {@code null}
   */
  public static void useMemory(
