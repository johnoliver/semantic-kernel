...
class DefaultContextVariables implements ContextVariables, WritableContextVariables {
	...
	/// </summary>
	/// <param name="content">Optional value for the main variable of the
	/// context.</param>
	...
	/// </summary>
	/// <param name="content">The new input value, for the next function in the
	/// pipeline, or as a
	// result for the user
	...
	/// <param name="merge">Whether to merge and keep old data, or replace. False ==
	/// discard old
	// data.</param>
	/// <returns>The current instance</returns>
