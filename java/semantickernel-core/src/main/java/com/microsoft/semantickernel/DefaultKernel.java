...
public class DefaultKernel implements Kernel {
    ...
    if (TextCompletion.class.isAssignableFrom(clazz)) {
      ...
      if (factory == null) {
        throw new KernelException(
            KernelException.ErrorCodes.ServiceNotFound, "No text completion service available");
      }
      ...
      if (factory == null) {
        throw new KernelException(
            KernelException.ErrorCodes.ServiceNotFound, "No chat completion service available");
      }
  ...
  public ReadOnlyFunctionCollection importSkill(
      String skillName, Map<String, SemanticFunctionConfig> skills) throws SkillsNotFoundException {
