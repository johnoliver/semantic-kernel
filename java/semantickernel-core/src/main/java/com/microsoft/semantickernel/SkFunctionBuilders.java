...
public class SkFunctionBuilders implements FunctionBuilders {
  ...
  private static class InternalCompletionBuilder extends CompletionSKFunction.Builder {
    ...
    public CompletionSKFunction createFunction(
      ...
      return register(DefaultCompletionSKFunction.createFunction(functionName, functionConfig));
    }
    ...
    public CompletionSKFunction createFunction(
      ...
      return register(
          DefaultCompletionSKFunction.createFunction(skillNameFinal, functionName, functionConfig));
    }
