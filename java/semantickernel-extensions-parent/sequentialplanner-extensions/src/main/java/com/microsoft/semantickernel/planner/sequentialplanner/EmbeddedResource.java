...
public class EmbeddedResource {
	...
	// typeof(EmbeddedResource).Namespace;
	...
	public static String read(String name) {
		 ...
		 * if (assembly == null) { throw new
		 * PlanningException(PlanningException.ErrorCodes.InvalidConfiguration,
		 * $"[{s_namespace}] {name} assembly not found"); }
		 * 
		 * using Stream? resource = assembly.GetManifestResourceStream($"{s_namespace}."
		 * + name);
