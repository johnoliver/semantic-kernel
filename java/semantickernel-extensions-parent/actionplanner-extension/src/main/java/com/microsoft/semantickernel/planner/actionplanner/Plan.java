...
/**
 * Standard Semantic Kernel callable plan. Plan is used to create trees of
 * SKFunctions.
 */
public class Plan extends AbstractSkFunction<CompletionRequestSettings> {
	...
	/**
	 * Adds one or more existing plans to the end of the current plan as steps. When
	 * you add a plan
	 * as a step to the current plan, the steps of the added plan are executed after
	 * the steps of
	 * the current plan have completed.
	 *
	 * @param steps
	 *         The plans to add as steps to the current plan.
	 */
	...
	/**
	 * Adds one or more new steps to the end of the current plan. When you add a new
	 * step to the
	 * current plan, it is executed after the previous step in the plan has
	 * completed. Each step can
	 * be a function call or another plan.
	 *
	 * @param steps
	 *         The steps to add to the current plan.
	 */
	public void addSteps(CompletionSKFunction... steps) {
		List<Plan> plans = Arrays.stream(steps)
	...
	/**
	 * Runs the next step in the plan using the provided kernel instance and
	 * variables.
	 *
	 * <p>
	 * This method executes the next step in the plan using the specified kernel
	 * instance and
	 * context variables. The context variables contain the necessary information
	 * for executing the
	 * plan, such as the memory, skills, and logger. The method returns a task
	 * representing the
	 * asynchronous execution of the plan's next step.
	 *
	 * @param kernel
	 *         The kernel instance to use for executing the plan.
	 * @param variables
	 *         The variables to use for the execution of the plan.
	 * @return A task representing the asynchronous execution of the plan's next
	 *         step.
	 */
	 ...
	 *
	 * @param variables
	 *         Variables to use for expansion.
	 * @param input
