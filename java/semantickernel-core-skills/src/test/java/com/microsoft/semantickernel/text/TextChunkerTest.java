...
public class TextChunkerTest {
	...
	public void canSplitPlainTextLinesLongString() {
		String input = "This is a very very very very very very long string with nothing to split on.";
		List<String> expected = Arrays.asList(
	...
	public void canSplitPlainTextLinesNoSeparator() {
		...
		List<String> expected = Arrays.asList("Thisisaveryveryveryveryveryver", "ylongstringwithnothingtospliton");
