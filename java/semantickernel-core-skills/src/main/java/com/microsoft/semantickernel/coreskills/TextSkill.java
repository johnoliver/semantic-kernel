...
public class TextSkill {
	...
	public String uppercase(
		@SKFunctionInputAttribute @SKFunctionParameters(description = "Text to uppercase", name = "input") String text) {
		return text.toUpperCase(Locale.ROOT);
	}

	@DefineSKFunction(description = "Remove spaces to the left of a string.", name = "LStrip")
	public String lStrip(
		@SKFunctionInputAttribute @SKFunctionParameters(description = "Text to edit", name = "input") String text) {
	...
	public String strip(
		@SKFunctionInputAttribute @SKFunctionParameters(description = "Text to edit", name = "input") String input) {
		return input.trim();
	}

	@DefineSKFunction(description = "Change all string chars to lowercase", name = "lowercase")
	public String lowercase(
		@SKFunctionInputAttribute @SKFunctionParameters(description = "Text to lowercase", name = "input") String input) {
