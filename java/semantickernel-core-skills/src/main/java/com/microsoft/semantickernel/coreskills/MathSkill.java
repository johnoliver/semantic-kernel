 ...
 * </blockquote>
 *
 * @implNote This skill uses BigDecimal to perform the number conversion and the
 *           calculations.
 */
public class MathSkill {
	 ...
	 *
	 * @param input
	 *         Initial value as string to add the specified amount
	 * @param amount
	 *         The amount to be added to input
	 * @return The resulting sum as a String.
	 */
	@DefineSKFunction(description = "Adds amount to a value.", name = "add")
	public String add(
		@SKFunctionInputAttribute @SKFunctionParameters(name = "input", description = "The value to add to.") String input,
	 ...
	 *
	 * <p>
	 * This skill attempts to convert the numbers to BigDecimal and then subtract
	 * them.
	 *
	 * <p>
	 * If a conversion error occurs, the skill will throw an exception.
	 *
	 * @param input
	 *         Initial value as string to subtract the specified amount
	 * @param amount
	 *         The amount to be subtracted from input
	 * @return The resulting difference as a String.
	 */
	@DefineSKFunction(description = "Subtracts amount from value.", name = "Subtract")
	public String subtract(
		@SKFunctionInputAttribute @SKFunctionParameters(name = "input", description = "The value to subtract from.") String input,
		@SKFunctionParameters(name = "amount", description = "The amount to be subtracted from value.") String amount) {
