...
public class TextChunker {
  ...
  public static List<String> splitPlainTextParagraphs(
    ...
    return internalSplitTextParagraphs(
        ...
        (text) -> internalSplitLines(text, maxTokensPerParagraph, false, s_plaintextSplitOptions));
  }
  ...
  public static List<String> splitMarkdownParagraphs(
    ...
    return internalSplitTextParagraphs(
        lines,
        maxTokensPerParagraph,
        (text) -> internalSplitLines(text, maxTokensPerParagraph, false, s_markdownSplitOptions));
  }
