...
public class TextMemorySkill {
  ...
  public Mono<String> retrieveAsync(
      ...
      @SKFunctionParameters(
              ...
              description = "Memories collection associated with the memory to retrieve",
  ...
  public Mono<SKContext> saveAsync(
      ...
      @SKFunctionParameters(
              name = collectionParam,
              description = "Memories collection associated with the information to save",
              defaultValue = DefaultCollection,
              type = String.class)
          String collection,
      @SKFunctionParameters(
