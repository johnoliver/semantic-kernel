...
class SemanticFunctionConstants {
	...
	public static final String GetConversationActionItemsDefinition = "You are an action item extractor. You will be given chat history and need to make note"
	...
	public static final String GetConversationTopicsDefinition = "Analyze the following extract taken from a conversation transcript and extract key"
		+ " topics.\n"
